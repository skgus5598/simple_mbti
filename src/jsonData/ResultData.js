...
export const ENFJ = require('../img/mbti_1/ENFJ.png');
export const ENFP = require('../img/mbti_1/ENFP.png');
export const ENTJ = require('../img/mbti_1/ENTJ.png');
export const ENTP = require('../img/mbti_1/ENTP.png');
export const ESFJ = require('../img/mbti_1/ESFJ.png');
export const ESFP = require('../img/mbti_1/ESFP.png');
export const ESTJ = require('../img/mbti_1/ESTJ.png');
export const ESTP = require('../img/mbti_1/ESTP.png');
export const INFJ = require('../img/mbti_1/INFJ.png');
export const INFP = require('../img/mbti_1/INFP.png');
export const INTJ = require('../img/mbti_1/INTJ.png');
export const INTP = require('../img/mbti_1/INTP.png');
export const ISFJ = require('../img/mbti_1/ISFJ.png');
export const ISFP = require('../img/mbti_1/ISFP.png');
export const ISTJ = require('../img/mbti_1/ISTJ.png');
export const ISTP = require('../img/mbti_1/ISTP.png');

export const ENFJ2 = require('../img/ENFJ_2.jpeg');
export const ENFP2 = require('../img/ENFP_2.jpeg');
export const ENTJ2 = require('../img/ENTJ_2.png');
export const ENTP2 = require('../img/ENTP_2.png');
export const ESFJ2 = require('../img/ESFJ_2.jpeg');
export const ESFP2 = require('../img/ESFP_2.png');
export const ESTJ2 = require('../img/ESTJ_2.jpeg');
export const ESTP2 = require('../img/ESTP_2.jpeg');
export const INFJ2 = require('../img/INFJ_2.jpeg');
export const INFP2 = require('../img/INFP_2.png');
export const INTJ2 = require('../img/INTJ_2.png');
export const INTP2 = require('../img/INTP_2.jpeg');
export const ISFJ2 = require('../img/ISFJ_2.jpeg');
export const ISFP2 = require('../img/ISFP_2.png');
export const ISTJ2 = require('../img/ISTJ_2.jpeg');
export const ISTP2 = require('../img/ISTP_2.png');
...
export const mbtiData = [
    {
        ...
        "desc1" : "Extraverted, Intuitive, Feeling, and Judging",
        "desc2" : "Protagonists (ENFJs) feel called to serve a greater purpose in life. Thoughtful and idealistic, these personality types strive to have a positive impact on other people and the world around them. They rarely shy away from an opportunity to do the right thing, even when doing so is far from easy. Protagonists are born leaders, which explains why these personalities can be found among many notable politicians, coaches, and teachers. Their passion and charisma allow them to inspire others not just in their careers but in every arena of their lives, including their relationships. Few things bring Protagonists a deeper sense of joy and fulfillment than guiding friends and loved ones to grow into their best selves."
    },
    {
        "name" : "ENFP",
        "imgUrl" : ENFP2,
        "imgUrl2" : ENFP,
        "personality":"Campaigne Personality",
        "desc1" : "Extraverted, Intuitive, Feeling, and Prospecting",
        "desc2" : "Campaigners (ENFPs) are true free spirits – outgoing, openhearted, and open-minded. With their lively, upbeat approach to life, they stand out in any crowd. But even though they can be the life of the party, Campaigners don’t just care about having a good time. These personality types run deep – as does their longing for meaningful, emotional connections with other people. Campaigners are proof that seeking out life’s joys and pleasures isn’t the same as being shallow. Seemingly in the blink of an eye, people with this personality type can transform from impassioned idealists to carefree figures on the dance floor."
    },
    {
        "name" : "ENTJ",
        "imgUrl" : ENTJ2,
        ...
        "desc1" : "Extraverted, Intuitive, Thinking, and Judging",
        "desc2" : "Commanders are natural-born leaders. People with this personality type embody the gifts of charisma and confidence, and project authority in a way that draws crowds together behind a common goal. However, Commanders are also characterized by an often ruthless level of rationality, using their drive, determination and sharp minds to achieve whatever end they’ve set for themselves. Perhaps it is best that they make up only three percent of the population, lest they overwhelm the more timid and sensitive personality types that make up much of the rest of the world – but we have Commanders to thank for many of the businesses and institutions we take for granted every day."
    },
    {
        "name" : "ENTP",
        "imgUrl" : ENTP2,
